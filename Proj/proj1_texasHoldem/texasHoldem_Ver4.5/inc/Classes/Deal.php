...
//    }
    ...
    public function setBettingOrder($num){
        $this->bettingOrder=$num%$this->nPlayers;
    }
    ...
    public function bettingProcess(){
    ...
    public function getIBO(){
        return $this->initBettingOrder;
    }
    public function setIBO(){
        $this->initBettingOrder=$this->bettingOrder;
    }
