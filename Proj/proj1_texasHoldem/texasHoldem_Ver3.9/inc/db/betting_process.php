...
function get_betting_order($stage){
    if($stage==0) {require 'preflop.php';}
    else if($stage==0) {require 'flop.php';}
    else if($stage==0) {require 'turn.php';}
    else if($stage==0) {require 'river.php';}
