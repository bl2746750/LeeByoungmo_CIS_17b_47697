...
--
-- Temporary table structure for view `blee_view_book_info`
--

DROP TABLE IF EXISTS `blee_view_book_info`;
/*!50001 DROP VIEW IF EXISTS `blee_view_book_info`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `blee_view_book_info` (
...
--
-- Final view structure for view `blee_view_book_info`
--

/*!50001 DROP TABLE IF EXISTS `blee_view_book_info`*/;
/*!50001 DROP VIEW IF EXISTS `blee_view_book_info`*/;
...
-- Dump completed on 2019-11-24 20:25:06
